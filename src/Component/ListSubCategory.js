...
export default function ListSubCategory({ CatData }) {
              ...
              <Grid>
                ...
                >
                  <Select
                    ...
                    name="category_id"
                  />
                  <Typography>Enter Tool Component Name :</Typography>
                  <TextField required fullWidth id="name" name="name" />
                  <Typography>Enter Tool Component Description:</Typography>
                  <TextField
                    required
                    fullWidth
                    id="description"
